...
const UserRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // save token (if returned) and go to quiz
  ...
  return (
    <>
      <div className="aroma-register aroma-bg flex items-center justify-center min-h-screen px-4 relative">
          ...
          <div className="card-glass relative rounded-none px-8 py-10 fade-in fade-in-2">
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div className="fade-in fade-in-3">
                <label className="aroma-label" htmlFor="name">Full Name</label>
              ...
              {/* Submit */}
              <div className="fade-in fade-in-6" style={{ marginTop: "4px" }}>
                <button
                  type="submit"
                  disabled={loading}
                  className="aroma-btn"
